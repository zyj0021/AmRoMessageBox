...
namespace AmRoMessageDialog
{
    public class AmRoMessageBox
    {
        ...
        internal string Caption { internal get; set; }
        internal string Message { internal get; set; }
        internal AmRoMessageBoxButton MessageBoxButton { internal get; set; }
        internal AmRoMessageBoxIcon MessageBoxIcon { internal get; set; }
        internal bool ReverseContentDirection { internal get; set; }
